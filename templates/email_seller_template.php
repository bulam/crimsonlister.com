...
<form method="post" action="email_seller.php">
			<div class="control-group">
				...
				<input type="text" name="contactname" id="contactname" class="required" role="input" aria-required="true" 
				<?php print('value="'.$buyer_query[0]["firstname"] .'"');?>/>
			</div>
			...
			<div class="control-group">
				...
				<?php print('value="'.$buyer_query[0]["username"]  .'"');?>/>		
			</div>
